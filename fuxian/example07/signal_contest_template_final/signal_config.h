...
#define SIGNAL_DAC_UPDATE_RATE_HZ    (500000U)
#define SIGNAL_DDS_FREQUENCY_HZ      (10000.0f)
#define SIGNAL_SWEEP_POINTS          (16U)
#define SIGNAL_TARGET_FREQUENCY_HZ   (10000.0f)
#define SIGNAL_HARMONIC_BASE_HZ      (10000.0f)
#define SIGNAL_DAC_TABLE_COUNT       (1024U)
#define SIGNAL_DAC_BITS              (12U)
#define SIGNAL_COMP_GAIN_MIN         (0.25f)
#define SIGNAL_COMP_GAIN_MAX         (4.0f)
