    ...
    signal_dual_adc_phase_result_t *result)
{
    ...
    uint32_t x_crossings[SIGNAL_DUAL_ADC_PHASE_MAX_X_CROSSINGS];
    uint32_t y_crossings[SIGNAL_DUAL_ADC_PHASE_MAX_Y_CROSSINGS];
    int16_t phase_values[SIGNAL_DUAL_ADC_PHASE_MAX_X_CROSSINGS];
