...
本目录已按 24_C 原双路同步采集、动态采样率、FFT/谐波、突发捕获和波形显示功能重建。波形绘制使用集成库新增的 `tft_waveform_st7789` 模块，main 不再依赖 ILI9341。按 `24_C_01_模块选择与SysConfig.md` 到 `24_C_07_验证与赛场复现.md` 复现比赛步骤。
