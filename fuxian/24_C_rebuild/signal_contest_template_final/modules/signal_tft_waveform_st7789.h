#ifndef SIGNAL_TFT_WAVEFORM_ST7789_H
#define SIGNAL_TFT_WAVEFORM_ST7789_H
...
} signal_tft_waveform_st7789_mode_t;

typedef enum {
    SIGNAL_TFT_WAVEFORM_FIXED_SCALE = 0,
    SIGNAL_TFT_WAVEFORM_AUTO_SCALE
} signal_tft_waveform_st7789_scale_mode_t;
...
typedef struct {
    ...
    uint16_t width;
    uint16_t height;
    signal_tft_waveform_st7789_mode_t mode;
    signal_tft_waveform_st7789_scale_mode_t scale_mode;
    ...
    bool draw_border;
    bool draw_baseline;
} signal_tft_waveform_st7789_config_t;
...
} signal_tft_waveform_st7789_result_t;
...
#endif /* SIGNAL_TFT_WAVEFORM_ST7789_H */
