...
2026-08-07 实板记录：`g_acceptance_complete=true`、`g_acceptance_pass=true`、`g_completed_sizes=5`、`g_total_completed_blocks=500`、`g_wfe_completed_blocks=500`、`g_failed_block=0xFFFFFFFF`、`g_sentinel_residue_count=0`、`g_fcc_pass=true`；最后一帧 TMP6131 raw min/max/mean 为 2073/2076/2074。因此 LEVEL 1 已通过。
