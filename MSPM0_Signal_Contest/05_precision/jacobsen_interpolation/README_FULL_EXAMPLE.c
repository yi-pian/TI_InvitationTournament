/* jacobsen_interpolation 全功能示例：与当前 public header 的全部 Signal* API 一一对应。 */
#include <stddef.h>
#include <stdint.h>
#include <stdbool.h>
#include "signal_jacobsen_interpolation.h"

void jacobsen_interpolation_FullExample(void)
{
    ...
    /* ===== 调用 SignalJacobsen_Process：先阅读 README 的前置状态和参数单位 ===== */
